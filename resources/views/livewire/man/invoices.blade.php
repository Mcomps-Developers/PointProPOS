                            ...
                            <tbody>
                                @foreach ($invoices as $item)
                                    <tr>
                                        ...
                                        <td><span style="margin-bottom: 6px;">KES {{ number_format($item->repayments()->sum('amount_paid'), 2) }}</span> <br>
                                            <small>
                                                <div class="progress progress-sm custom-progress-3 progress-animate"
                                                    role="progressbar"
                                                    ...
                                                    <div class="progress-bar"
                                                        ...
                                                        <div title="Paid KES {{ number_format($item->repayments()->sum('amount_paid'), 2) }} out of KES {{ number_format($item->amount, 2) }}"
                                                            class="progress-bar-value" style="transform: scale(0.75)">
