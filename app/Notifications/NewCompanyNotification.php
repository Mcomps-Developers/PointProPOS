...
class NewCompanyNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Thank you for choosing ' . env('APP_NAME') . ' as your Pont of Sale (POS) solution. It is great to see make the best strategic move to revolutionize and effectively manage your sales in real time. Big Up!')
